  ...
  const fieldRules = {
    ...
    password: {
      ...
      pattern: {
        value: /^(?=.*?[A-Z])(?=.*?[0-9]).{8,}$/,
        message:
          "Password must contain minimum length of 8 characters, at least one uppercase letter and one digit",
      },
    },
    fullName: {
      required: "This field is required.",
          ...
          <div className={style.formContainer}>
            <div className={style.formSec}>
              ...
              >
                ...
                <div className={style.midFormSec}>
                  <div className={style.formGroup}>
                        ...
                        <Controller
                          ...
                          render={({ field: { onChange, value } }) => (
                            ...
                            >
                              ...
                              <option value="uae" key="">
                                UAE
                              </option>
                              <option value="china" key="">
                                China
                              </option>
                            </Input>
                          )}
